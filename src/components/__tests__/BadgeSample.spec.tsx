...
describe("Badge", () => {
    ...
    it("should render the structure", () => {
        ...
        expect(
            badge.equals(
                <span className="widget-hellogithubaction badge label-default">0</span>
            )
        ).toEqual(true);
    });
    ...
    it("with a click action should respond to click events", () => {
        const badgeProps: BadgeSampleProps = { onClickAction: jasmine.createSpy("onClick"), type: "badge" };
